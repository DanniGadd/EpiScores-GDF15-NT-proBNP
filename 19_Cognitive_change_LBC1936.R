...
# Lag time from W1 fit in growth curves for slope in cog ablity scores
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/General_Cog_ability_Score_intercept_LBC1936_assocs_2_EpiScores_basic_15122022.csv", row.names = FALSE)
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/General_Cog_change(slope)_LBC1936_assocs_2_EpiScores_basic_15122022.csv", row.names = FALSE)
