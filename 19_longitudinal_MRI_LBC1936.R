...
#scaled = names(LBC[329:412])
#for (i in scaled){
 # LBC[,i] <- apply(LBC[,i], 2, scale)
#}
...
#   IGMV =~
#     gm_mm3_w2         1.000                               4.349    0.977
#     gm_mm3_w3         1.000                               4.349    0.998
#     gm_mm3_w4         1.000                               4.349    0.988
#     gm_mm3_w5         1.000                               4.349    0.980
#   SGMV =~
#     gm_mm3_w2         0.000                               0.000    0.000
#     gm_mm3_w3         3.760                               0.611    0.140
#     gm_mm3_w4         6.830                               1.110    0.252
#     gm_mm3_w5         9.550                               1.553    0.350
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/GM_intercept_LBC1936_assocs_2_EpiScores_basic_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/GM_slope_LBC1936_assocs_84_EpiScores_basic_16122022.csv")
...
#                    Estimate  Std.Err  z-value  P(>|z|)   Std.lv  Std.all
#   ITMV =~
#     brain_mm3_w2      1.000                               8.844    0.988
#     brain_mm3_w3      1.000                               8.844    1.003
#     brain_mm3_w4      1.000                               8.844    1.007
#     brain_mm3_w5      1.000                               8.844    1.018
#   STMV =~
#     brain_mm3_w2      0.000                               0.000    0.000
#     brain_mm3_w3      3.760                               0.673    0.076
#     brain_mm3_w4      6.830                               1.222    0.139
#     brain_mm3_w5      9.550                               1.709    0.197
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/Total_Brain_intercept_LBC1936_assocs_2_EpiScores_basic_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/Total_Brain_slope_LBC1936_assocs_2_EpiScores_basic_16122022.csv")
...
#                    Estimate  Std.Err  z-value  P(>|z|)   Std.lv  Std.all
#   INAWMV =~
#     nawm_mm3_w2       1.000                               4.992    0.988
#     nawm_mm3_w3       1.000                               4.992    0.940
#     nawm_mm3_w4       1.000                               4.992    0.880
#     nawm_mm3_w5       1.000                               4.992    0.834
#   SNAWMV =~
#     nawm_mm3_w2       0.000                               0.000    0.000
#     nawm_mm3_w3       3.760                               1.052    0.198
#     nawm_mm3_w4       6.830                               1.911    0.337
#     nawm_mm3_w5       9.550                               2.673    0.447
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/NAWM_intercept_LBC1936_assocs_2_EpiScores_basic_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/NAWM_slope_LBC1936_assocs_2_EpiScores_basic_16122022.csv")
...
#                    Estimate  Std.Err  z-value  P(>|z|)   Std.lv  Std.all
#   IWMHV =~
#     wmh_mm3_log_w2    1.000                               1.104    0.631
#     wmh_mm3_log_w3    1.000                               1.104    1.077
#     wmh_mm3_log_w4    1.000                               1.104    1.137
#     wmh_mm3_log_w5    1.000                               1.104    1.175
#   SWMHV =~
#     wmh_mm3_log_w2    0.000                               0.000    0.000
#     wmh_mm3_log_w3    3.760                               0.190    0.185
#     wmh_mm3_log_w4    6.830                               0.344    0.355
#     wmh_mm3_log_w5    9.550                               0.482    0.513
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/WMH_intercept_LBC1937_assocs_2_EpiScores_basic_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/WMH_slope_LBC1937_assocs_2_EpiScores_basic_16122022.csv")
