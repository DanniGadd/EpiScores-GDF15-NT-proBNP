...
for(i in episcores) { 
  ...
  GM_model_reg <-  '
    ...
    gm_mm3_w5 ~ Age_w5
    tmp ~ Age_w1
    IGMV ~ tmp + ICV_mm3_wX + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
    SGMV ~ tmp + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/GM_intercept_LBC1936_assocs_2_EpiScores_full_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/GM_slope_LBC1936_assocs_84_EpiScores_full_16122022.csv")
...
for(i in episcores) { 
  ...
  Brain_model_reg <-  '
   ...
   # regressions 
     ...
     brain_mm3_w5 ~ Age_w5 
     tmp ~ Age_w1
     ITMV ~ tmp + ICV_mm3_wX + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
     STMV ~ tmp + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
    '
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/Total_Brain_intercept_LBC1936_assocs_2_EpiScores_full_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/Total_Brain_slope_LBC1936_assocs_2_EpiScores_full_16122022.csv")
...
for(i in episcores) { 
  ...
  nawm_mm3_w5 ~ Age_w5
  tmp ~ Age_w1
  INAWMV ~ tmp + ICV_mm3_wX + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
  SNAWMV ~ tmp + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
  '
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/NAWM_intercept_LBC1936_assocs_2_EpiScores_full_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/NAWM_slope_LBC1936_assocs_2_EpiScores_full_16122022.csv")
...
for(i in episcores) { 
  ...
  # latent variables
   ...
   # regressions 
     ...
     wmh_mm3_log_w5 ~ Age_w5
     tmp ~ Age_w1
     IWMHV ~ tmp + ICV_mm3_wX + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
     SWMHV ~ tmp + sex + neut + lymph + mono + eosin + baso + smokingScore + bmi_w1 + depind_w1 + alcunitwk_w1
  '
...
write.csv(results, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/WMH_intercept_LBC1937_assocs_2_EpiScores_full_16122022.csv")
write.csv(results_slope, file = "/Cluster_Filespace/Marioni_Group/Danni/GS_added_biomarkers/00_Analysis_20k/04_LBC/SEM_results/LBC_brain/WMH_slope_LBC1937_assocs_2_EpiScores_full_16122022.csv")
